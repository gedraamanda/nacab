...
function add_estilos_e_scripts() {
	...
	wp_enqueue_style( 'bootstrap-font', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css' );
	wp_enqueue_style( 'css', get_template_directory_uri() . '/style.css');
	wp_enqueue_style( 'own-css', 'https://cdn.jsdelivr.net/npm/owl.carousel@2.3.4/dist/assets/owl.carousel.min.css');
    ...
    wp_enqueue_script( 'boots-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js', array(), '', true );
    wp_enqueue_script( 'boots-2-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js', array(), '', true );
    wp_enqueue_script( 'poopers-js', 'https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js', array(), '', true );
    wp_enqueue_script( 'own-js', 'https://cdn.jsdelivr.net/npm/owl.carousel@2.3.4/dist/owl.carousel.min.js', array(), '', true );
